<?php
namespace Thunderkiss52\LaravelPermission;
...
use Thunderkiss52\LaravelPermission\Attributes\CanAssign;
use Thunderkiss52\LaravelPermission\Attributes\HasPermission;
use Thunderkiss52\LaravelPermission\Exceptions\PermissionException;
